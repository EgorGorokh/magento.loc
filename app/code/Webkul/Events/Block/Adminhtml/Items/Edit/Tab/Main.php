...
namespace Webkul\Events\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_webkul_events_items');
        ...
        $fieldset->addField(
            'reason',
            'text',
            ['name' => 'reason', 'label' => __('Name'), 'title' => __('Name'), 'required' => true]
        );
        $fieldset->addField(
            'date',
            'date',
