...
class Save extends \Webkul\Events\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('webkul/events');
                        ...
                        $imagePath = 'webkul/events'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('webkul_events/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('webkul_events/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('webkul_events/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('webkul_events/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('webkul_events/*/');
