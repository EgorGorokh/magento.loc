...
namespace Webkul\Events\Controller\Adminhtml;
...
abstract class Items extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Webkul_Events::items')->_addBreadcrumb(__('Items'), __('Items'));
        return $this;
    }
    ...
    {
        return $this->_authorization->isAllowed('Webkul_Events::items');
    }
}
